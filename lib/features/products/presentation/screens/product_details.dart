...
class _ProductDetailsState extends State<ProductDetails> {
  int _quantity = 1;
  final _productCubit = getIt.get<ProductsCubit>();
  @override
              ...
              children: [
                ...
                Row(
                  children: [
                    ...
                    ProductCounter(
                      initialValue: _productCubit.quantity,
                      onIncrement: _productCubit.changeQuantity,
                      onDecrement: _productCubit.changeQuantity,
                    ),
                  ],
                ),
                SizedBox(
                      ...
                      children: [
                        ...
                        BlocBuilder<ProductsCubit, ProductsState>(
                          builder: (context, state) {
                            return Text(
                              'EGP ${(product.priceAfterDiscount ?? product.price) * _productCubit.quantity}',
                              style: getMediumStyle(
